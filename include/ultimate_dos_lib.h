...
unsigned long uii_file_size();                                    // Get size of currently open file
...
void uii_save_reu(unsigned long reu_addr, unsigned long size);    // Save REU memory to a file
void uii_load_reu(unsigned long reu_addr, unsigned long size);    // Load a file to REU memory
void uii_save_reu_image(char size);                               // Save REU to file at current path; size index selects REU size
void uii_load_reu_image(char size);                               // Load REU from file at current path; size index selects REU size
