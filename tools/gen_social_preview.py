#!/usr/bin/env python3
"""
Generate GitHub social preview image for heartbeat-demo.
Modeled on locifilemanager-v2/screenshots/social-preview.png layout
(same layout also used by OricScreenEditorLOCI and oricdemo2026).
...
# --- Paths ---
SCREEN_SHOT    = os.path.join(REPO_ROOT, 'screenshots', 'visualizer.png')
...
# --- Layout (mirroring locifilemanager-v2/OricScreenEditorLOCI/oricdemo2026 layout) ---
...
# Text positions (y baselines matching FM/OSE/oricdemo2026 layout)
...
# --- Load the visualiser screenshot ---
...
# Paste visualiser screenshot (with 4px green border)
border = 4
draw.rectangle(
...
draw.text((TEXT_X, URL_Y),    "github.com/xahmol/heartbeat-demo", font=font_url, fill=C_GREEN)
